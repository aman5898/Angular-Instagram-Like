...
@Injectable()     //use this decorator when you ar eusing one service into another
export class MyFireService {
  ...
  handleImageUpload(data) {
    ...
    const newPersonlPostKey = firebase.database().ref().child('myposts').push().key;
    ...
    const updates = {};
    updates['/myposts/' + user.uid + '/' + newPersonlPostKey] = personalPostDetails;
